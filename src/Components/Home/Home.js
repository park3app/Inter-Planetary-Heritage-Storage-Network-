  ...
  return (
    <div className='w-full h-full'>
      <div className='w-8/12 mx-auto py-28 text-[#00000087]'>
        ...
        <p>Inter Planetary Cultural Storage preserves the Histories and Cultures of the world. We believe that diversity of cultures is priceless, so we are recording the worlds stories in immutable blockchain records.</p>
      </div>
